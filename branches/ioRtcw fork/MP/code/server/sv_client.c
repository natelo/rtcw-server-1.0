...
void SV_GetChallenge( netadr_t from )
{
	...
	// L0 - Auth doesn't exist anymore...so why bother?!
/*
#ifndef STANDALONE
...
#endif
	{
		// L0 - Let them connect from different version..
		/*
		...
		*/
		Com_Printf("(NOTICE) Client successfully connected from rtcw version %i\n", version);
 	}
#endif
